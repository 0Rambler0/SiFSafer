...
from data_utils import (Dataset_FoR, genSpoof_list_2021)
...
def main(args: argparse.Namespace) -> None:
    ...
    database_path = "your FoR dataset path"
    protocol_file = "your FoR protocol file"
    eval_trial_path = os.path.join(database_path, protocol_file)
...
def get_loader(
    ...
    eval_database_path = os.path.join(database_path, "ASVspoof2019_LA_eval/flac/")

    eval_trial_path = os.path.join(database_path, "protocol_file")

    # file_eval = genSpoof_list_2021(dir_meta=eval_trial_path, track=track)
    eval_set = Dataset_FoR(base_dir=eval_database_path, protocol_path=eval_trial_path)
